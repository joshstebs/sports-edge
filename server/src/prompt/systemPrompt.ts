...
- "odds": null when unknown (never invent odds). "confidence" is REQUIRED on every leg: an integer 0-100 equal to your true P(over) — never omit it. The legs array length must match the number of legs the user requested.
